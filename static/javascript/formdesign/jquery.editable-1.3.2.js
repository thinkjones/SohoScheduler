...
$.fn.editable = function(options){
	...
	if(options=='disable')
		return this.unbind('click',this.data('editable.options').toEditable);
	if(options=='enable')
		return this.bind('click',this.data('editable.options').toEditable);
	if(options=='destroy')
		return  this.unbind('click',this.data('editable.options').toEditable)
	...
	return  this.one('click',this.data('editable.options').toEditable);
}
$.editableFactory = {
	'text': {
